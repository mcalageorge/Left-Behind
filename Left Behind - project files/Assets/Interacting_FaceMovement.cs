...
public class Interacting_FaceMovement : MonoBehaviour
{
    ...
    public void ShortenFont() {

        text_on_screen.fontSize = 35;
    
    }

    public bool didTalk = false;

    public void EnlargeFont()
    {

        text_on_screen.fontSize = 40;
